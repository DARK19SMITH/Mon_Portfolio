            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-16 mt-16 border-t border-zinc-900 pt-16">
              <div className="max-w-xl space-y-6">
                  <p className="text-xl md:text-2xl text-zinc-400 leading-relaxed font-light">
                    Étudiant de 18 ans et Développeur Fullstack passionné par la cybersécurité. J'apprends actuellement les bases du domaine et je m'y lance avec enthousiasme, tout en concevant des solutions numériques robustes à Abidjan.
                  </p>
